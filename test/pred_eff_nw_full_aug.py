...
sal_dir = vis_dir + '/eff_nw_full_aug_sal' 
...
json_file = open('../models/eff_nw_full_aug_model.json', 'r')
loaded_model = json_file.read()
json_file.close()
model = model_from_json(loaded_model)

model.load_weights('../models/eff_nw_full_aug_weights.hdf5')
model.summary()
...
plot_roc(val_preds, val_slice, 'eff_nw_full_aug')
...
preds_bool = save_preds(preds, test_filenames, test_slice, 'eff_nw_full_aug')
