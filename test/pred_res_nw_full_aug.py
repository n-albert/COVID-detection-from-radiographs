...
cam_dir = vis_dir + '/res_nw_full_aug_cam'
...
json_file = open('../models/res_nw_full_aug_model.json', 'r')
loaded_model = json_file.read()
json_file.close()
model = model_from_json(loaded_model)

model.load_weights('../models/res_nw_full_aug_weights.hdf5')
model.summary()
...
plot_roc(val_preds, val_slice, 'res_nw_full_aug')
...
preds_bool = save_preds(preds, test_filenames, test_slice, 'res_nw_full_aug')
