...
cam_dir = vis_dir + '/dense_nw_full_base_cam'
...
json_file = open('../models/dense_nw_full_base_model.json', 'r')
loaded_model = json_file.read()
json_file.close()
model = model_from_json(loaded_model)

model.load_weights('../models/dense_nw_full_base_weights.hdf5')
model.summary()
...
preds_bool = save_preds(preds, test_filenames, test_slice, 'dense_nw_full_base')
